...
const ArchivePostLayout = ({ heading }) => {
    ...
    return (
        <>
            ...
            <Outlet />
            <Routes>
                <Route path="/" element={<ArchivePosts state={state} setState={setState} heading={heading} getAllPosts={getAllPosts} />} />
...
export default ArchivePostLayout;