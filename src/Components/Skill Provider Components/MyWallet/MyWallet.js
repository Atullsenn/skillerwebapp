                            ...
                            <div className='main-transaction-div-area'>
                                ...
                                <div className='main-transaction-history-div'>
                                    {result.map((Item) => {
                                        return (
                                            <>
                                                <div>
                                                    ...
                                                    <div className='inner-transaction-history-div d-flex align-items-center' style={{justifyContent:'space-between', paddingLeft:"30px", paddingRight:'30px'}}>
                                     ...
                                     {Item.refundToSeeker ?
                                                            <p className='transaction-para p-0 m-0 blue'>Partially Refund To Seeker = $ {Item.refundToSeeker}</p>:  <p className='transaction-para p-0 m-0 blue'>{myWalletData.walletDataTwentySix} ($ {Item.bid_amount}) - {myWalletData.walletDataTwentySeven} ($ {Item.commission_amount}) = $ {Item.amount}</p>
                                    }
                                    {Item.refundToSeeker ?
                                                            <p className='transaction-para p-0 m-0 blue'>Platform Charges = $ {Item.commission_amount}</p>:""
                                    }
                                     {Item.refundToSeeker ?
                                                            <p className='transaction-para p-0 m-0 blue'>Total Credit Amount = $ {Item.amount}</p>:""
                                    }
